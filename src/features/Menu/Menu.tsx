...
export const Menu: React.FC = () => {
  ...
  //@ts-ignore
  const {dropMenu, dropProfileMenu, dropCanvasSettingSize} = useSelector(state => state.drop)
        ...
        <div className="menu">
          ...
          <div className={twMerge('my-5 mx-auto py-0 px-10 flex justify-between max-[1140px]:flex-col max-[1140px]:justify-start', isProfile && 'flex max-[1140px]:flex-row max-[1140px]:justify-between')}>
            ...
            {isLogin ? (
              ...
              <ul className={twMerge(`flex max-[1140px]:flex-col max-[1140px]:p-0 max-[1140px]:mt-[30vh]` ,!dropMenu && "max-[1140px]:hidden")}>
          ...
          <div
            className={twMerge(popup.register && "fixed top-0 bg-[#000000]/70 backdrop-opacity-30 z-50 w-screen h-screen flex justify-center items-center", popup.auth && "fixed top-0 bg-[#000000]/70 z-50 w-screen h-screen flex justify-center items-center", !dropMenu && "max-[1140px]:hidden")}
          >
            <Registration
