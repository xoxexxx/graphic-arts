...
export const EMenu:React.FC = () => {
    ...
    return(
        <div className="e-menu flex justify-between border-b border-[#dcdcdc] border-solid mx-auto px-10 h-[10vh]">
            <div className="e-menu__box-left flex items-center">
                <ul className="flex items-center m-0 p-0 text-[2.3vh]">
            ...
            <div className="e-menu__box-right flex items-center">
                <ul className="flex items-center m-0 p-0 text-[2.3vh]">
                    ...
                    <li className="flex items-center justify-center cursor-pointer mr-6 w-52 h-11 bg-[#784adc] text-white text-lg font-normal border-none rounded-xl text-[2.3vh] w-[15vw] h-[5vh]">Скачать проект <img className="w-[3vh] h-[3vh]" style={{margin: '0 0 0 10px'}} src={upload} alt="upload"/></li>
                    <li className="flex items-center justify-center cursor-pointer list-none m-0 roundex-xl"><img className="w-[8vh] h-[8vh]" src={test} alt="profile_creatiqa" /></li>
                </ul>
            </div>
        </div>
    )
