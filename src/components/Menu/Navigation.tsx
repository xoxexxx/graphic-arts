...
export const Navigation: React.FC = () => {
    ...
    return(
        <>
        <ul className={twMerge(`text-lg flex mt-4 mr-5 mb-0 ml-1 p-0 max-[1140px]:flex-col max-[1140px]:pb-6 max-[1140px]:border-b max-[1140px]:border-[#D9D9D9] max-[1140px]:border-solid` ,!dropMenu && "max-[1140px]:hidden" )}>
