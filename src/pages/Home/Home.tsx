...
export const Home = () => {
  ...
  return (
    <div className="home-header">
      <div className="home-header__box">
        <div className="home-header__box_subtitle">
          <p>
            ...
            дизайна, презентаций, макетов для полиграфии, графики для социальных
            сетей и многого другого в мире цифровых иллюстраций. Creatiqa
            подходит как профессионалам, так и любителям.
          </p>
        </div>
      ...
      <div className="home-header__start-button"><button>Начать бесплатно</button></div>
    </div>
  );
};
